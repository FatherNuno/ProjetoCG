...
int Orange::colision(int id, double v, double angle){
	return 0;
}
...
void Orange::changeVelocity(double delta_t){
	_vel = _vel + 0.00001*delta_t;
	_velmax = _velmax + 0.00001*delta_t;
}
...
void Orange::setTexture(GLuint id){
}
